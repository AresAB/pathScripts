...
pathorg2.sh: my first attempt at using flags within shell scripts. By default, it does the exact same thing as pathorg.sh, but it has 4 different flags. These flags can interact with one another, and make use of a custom 'flaghandler.sh' script to handle flag inputs (not included in this directory)
		-s | --search
